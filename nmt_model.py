...
class NMT(nn.Module):
    ...
    def forward(self, source: List[List[str]], target: List[List[str]]) -> torch.Tensor:
        ...
        # print("========== forward source_padded = ", source_padded.size())  
        # print("========== forward target_padded = ", target_padded.size())  
        # print("========== forward source_padded_chars = ", source_padded_chars.size())  
        # print("========== forward target_padded_chars = ", target_padded_chars.size())  
 
        enc_hiddens, dec_init_state = self.encode(source_padded_chars, source_lengths)
        enc_masks = self.generate_sent_masks(enc_hiddens, source_lengths)
        combined_outputs = self.decode(enc_hiddens, enc_masks, dec_init_state, target_padded_chars)
        # print("========== forward combined_outputs = ", combined_outputs.size())  
